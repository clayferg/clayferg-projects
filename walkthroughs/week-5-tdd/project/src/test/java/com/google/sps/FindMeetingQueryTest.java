...
public final class FindMeetingQueryTest {
  ...
  public void busyOptionalAttendeeIgnored() {
    // Should return the same as everyAttendeeIsConsidered because optional attendee C
    // is busy all day.
    // Events  : |--------------C--------------|
    //                 |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeIsConsidered() {
    ...
    // who has an event between 8:30 and 9:00. 
  ...
  public void justEnoughRoomIgnoreOptional() {
    ...
    Collection<Event> events =
        Arrays.asList(
            ...
            new Event(
                "Event 3",
                TimeRange.fromStartEnd(TIME_0830AM, TimeRange.getTimeInMinutes(8, 45), true),
                Arrays.asList(PERSON_B)));
  ...
  @Test
  public void justFreeOptionalAttendees() {
    ...
    Collection<Event> events = 
        Arrays.asList(
            new Event(
                "Event 1",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(7, 30), TimeRange.getTimeInMinutes(8, 30), false),
                Arrays.asList(PERSON_A)),
            new Event(
                "Event 2",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(9, 00), TimeRange.getTimeInMinutes(9, 30), true),
                Arrays.asList(PERSON_B)),
            new Event(
                "Event 2",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(9, 15), TimeRange.getTimeInMinutes(10, 30), false),
                Arrays.asList(PERSON_A)),
            new Event(
                "Event 2",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(11, 00), TimeRange.getTimeInMinutes(12, 30), false),
                Arrays.asList(PERSON_A)));
    ...
    Collection<TimeRange> expected = 
    Arrays.asList(
        TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.getTimeInMinutes(7, 30), false), 
        TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(8, 30), TimeRange.getTimeInMinutes(9, 00), false),
        TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(10, 30), TimeRange.getTimeInMinutes(11, 00), false),
        TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(12, 30), TimeRange.END_OF_DAY, true)
    );
  ...
  public void justBusyOptionalAttendees() {
    ...
    Collection<Event> events = 
        Arrays.asList(
            ...
            new Event(
                "Event 3",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(9, 30), TimeRange.getTimeInMinutes(11, 30), false),
                Arrays.asList(PERSON_A)),
            new Event(
                "Event 4",
  ...
  @Test
  public void mixedAttendees() {
    
    // Ensure that even when not all optional attendees can come
    ...
    Collection<Event> events = 
        Arrays.asList(
            ...
            new Event(
                "Event 2",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(5, 30), TimeRange.getTimeInMinutes(9, 30), false),
                Arrays.asList(PERSON_B)),
            new Event(
                "Event 3",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(17, 30), TimeRange.getTimeInMinutes(20, 30), false),
                Arrays.asList(PERSON_A)),
            new Event(
                "Event 4",
            ...
            new Event(
                "Event 5",
                TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.getTimeInMinutes(6, 30), false),
                Arrays.asList(PERSON_C)),
            new Event(
                "Event 6",
            ...
            new Event(
                "Event 7",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(14, 30), TimeRange.getTimeInMinutes(17, 30), false),
                Arrays.asList(PERSON_D)),
            new Event(
                "Event 8",
                TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(10, 30), TimeRange.getTimeInMinutes(14, 00), false),
                Arrays.asList(PERSON_E)));
        
    MeetingRequest request = new MeetingRequest(Arrays.asList(PERSON_A, PERSON_B), 180);
    request.addOptionalAttendee(PERSON_C); 
    ...
    Collection<TimeRange> expected = 
    Arrays.asList(
        TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(14,00), TimeRange.getTimeInMinutes(17, 30), false));

    Assert.assertEquals(expected, actual);
  }

  @Test
  public void eraseDuplicateAnswers() {
    ...
    Collection<TimeRange> expected = 
    Arrays.asList(
        TimeRange.fromStartEnd(TimeRange.getTimeInMinutes(9,30), TimeRange.getTimeInMinutes(17, 30), false));
