...
public final class FindMeetingQuery {
  ...
  private PotentialAttendeeList[] optionalRanges; 
  ...
  private void findPotentialGroupsOfOptionalAttendees(Event[] eventsOrderedByStart, Event[] eventsOrderedByEnd, Collection<Event> events, ArrayList<PotentialAttendeeList> resultsArrayList) {
    int startPointer = 0; 
    int endPointer = 0; 
  ...
  private void findPotentialTimesForRequiredAttendees(Event[] eventsOrderedByStart, Event[] eventsOrderedByEnd, Collection<Event> events) { 
    int windowStart = 0; 
    int windowClose = 0; 
    int startPointer = 0; 
    int endPointer = 0; 
  ...
  if (windowStart < END_OF_DAY && (END_OF_DAY - windowStart) >= request.getDuration()) {
  ...
  public Collection<TimeRange> query(Collection<Event> events, MeetingRequest request) {
    ...
    findPotentialTimesForRequiredAttendees(eventsOrderedByStart, eventsOrderedByEnd, events);

    optionalRanges = findPotentialOptionalAttendees(events, request); 
  ...
  private PotentialAttendeeList[] findPotentialOptionalAttendees(Collection<Event> events, MeetingRequest request) {
    ...
    findPotentialGroupsOfOptionalAttendees(eventsOrderedByStart, eventsOrderedByEnd, events, resultsArrayList); 
